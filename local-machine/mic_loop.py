...
STREAMING_LIMIT = 30000  # 5 minutes
RATE = 16000
...
def listen_print_loop(responses, stream, project_id, topic_id, customer_id):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            sentence = transcript.stip() + overwrite_chars
            print(sentence)
...
def main():
    ...
    with MicrophoneStream(RATE, CHUNK) as stream:
        while not stream.closed:
            ...
            listen_print_loop(responses, stream, project_id, topic_id, args[1])
